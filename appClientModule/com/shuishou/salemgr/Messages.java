...
public class Messages {
	private static final String BUNDLE_NAME_CN = "com.shuishou.salemgr.messages_cn"; //$NON-NLS-1$
	private static final String BUNDLE_NAME_EN = "com.shuishou.salemgr.messages_en"; //$NON-NLS-1$
